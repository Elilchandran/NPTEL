...
def fetch_course_registration_data():
    ...
    FROM
        Application app
    JOIN
        TermCourseRegistrationApplication t ON app.term_code = t.term_code  -- Joining Application to TermCourseRegistrationApplication
    JOIN
        Account ac ON app.student_email = ac.student_email                 -- Joining Application to Account
    JOIN
        Course c ON c.term_code = t.term_code                              -- Joining Course to TermCourseRegistrationApplication by term_code
    WHERE 
